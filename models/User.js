...
const userSchema = new mongoose.Schema({
  ...
  education: [{
    examName: String, // SSC, HSC, Madrasa, No Formal Education, etc.
    passingYear: Number,
    result: String, // GPA/CGPA or Grade
    board: String, // Board name or Institution
    rollNumber: String,
    registrationNumber: String,
    institutionName: String, // For Madrasa or other institutions
